...
const MarksDashboard = () => {
  ...
  // Show exam selection view when on /instructor/marks/edit
  const isEditSelection = location.pathname === '/instructor/marks/edit';
      ...
      {!isEditSelection ? (
        <div className="marks-grid">
          ...
          <div className="marks-card glass">
            ...
            <div className="card-controls">
              ...
              <button className="marks-action-btn" onClick={() => navigate('/instructor/marks/edit')}>Edit Marks</button>
            </div>
          </div>
        ...
        <div className="edit-selection-view">
          ...
          <div className="exam-selection-grid">
            <div className="marks-exam-card glass" onClick={() => navigate('/instructor/marks/edit/tt1')}>
              <h3>Term Test 1</h3>
              <p>Edit mapped marks for TT1.</p>
            </div>
            <div className="marks-exam-card glass" onClick={() => navigate('/instructor/marks/edit/tt2')}>
              <h3>Term Test 2</h3>
              <p>Edit mapped marks for TT2.</p>
            </div>
            <div className="marks-exam-card glass" onClick={() => navigate('/instructor/marks/edit/endSem')}>
