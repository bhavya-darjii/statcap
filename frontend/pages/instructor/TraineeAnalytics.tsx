 ...
 *
 * PURE UI â€” no business logic, no thresholds, no Supabase calls.
...
import "../trainee/TraineeDashboard.css";
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 14 }}>
        <div>
          ...
          <p style={{ margin: "6px 0 0", color: "rgba(255,255,255,0.75)", fontSize: "0.9rem" }}>
            {students.length} students Â· {courseMetric.courseName}
          </p>
        </div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px, 1fr))", gap: 18 }}>
                  ...
                  <div>
                    ...
                    <p style={{ margin: "3px 0 6px", fontSize: "0.75rem", color: "rgba(255,255,255,0.75)" }}>
                      {student.attendance.attended}/{student.attendance.total} sessions{student.attendance.atRisk ? ` Â· need >= ${ATT}%` : ""}
                    </p>
