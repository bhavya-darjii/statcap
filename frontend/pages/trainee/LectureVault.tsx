...
import '../instructor/LectureOverview.css';
...
const LectureVault = () => {
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Loading / Error States Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ VIEW 1: All Subjects Cards (when no subjectSlug is selected) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
            ...
            {courses.map((course) => {
              ...
              return (
                <div
                  ...
                  onClick={() => navigate(`/trainee/lecture-vault/${slug}`)}
                  role="button"
                  tabIndex={0}
                  onKeyDown={(e) => {
                    if (e.key === 'Enter' || e.key === ' ') {
                      navigate(`/trainee/lecture-vault/${slug}`);
                    }
                  }}
                >
  ...
  // Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ VIEW 2: Selected Subject Lecture Overview Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
  // - URL reflects subject: /trainee/lecture-vault/:subjectSlug
  // - Top bar: Only "Ã¢â€ Â All Subjects" button (no course text next to it)
              ...
              return (
                <section key={lectureKey} className="lecture-identity glass-card">
                  <div className="lecture-identity__info">
                    ...
                    <h3>{lecture.title}</h3>
                    <p>{lecture.moduleName || 'Course roadmap'} Ã‚Â· {lecture.description || 'Use this assistant to prepare the teaching flow.'}</p>
                  </div>

                  <div className="lecture-identity__actions">
                    <div className="lecture-status">
                      <span>{lecture.date ? `Lecture Conducted on: ${lecture.date} Ã‚Â· ${lecture.time || 'Time TBD'}` : 'Schedule TBD'}</span>
                    </div>
                    ...
                    {latestPpt ? (
                      <div className="lecture-history-mini">
                        ...
                        <div className="lecture-history-mini__controls">
                          ...
                          >
                            {isDownloading ? 'RetrievingÃ¢â‚¬Â¦' : 'Download'}
                          </button>
                        </div>
                      </div>
                    ) : (
